...
This package includes support for latin language (at libstemmer_c level), 
generated with the snowball compiler from {schinke contribution}[http://snowball.tartarus.org/otherapps/schinke/intro.html].
...
Latin is limited to ISO_8859_1 and you'll need to pass the encoding when creating a latin stemmer:
